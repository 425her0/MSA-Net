...
from models.modules import ShuffleV2Block, unetUp

class MSANet(nn.Module):
    def __init__(self, in_channels=3, n_classes=21, feature_scale=1, ESCC=True, MSIC=True):
        ...
        self.up_concat_3 = unetUp(self.filters[4], self.filters[-1], self.filters[4], self.ESCC)
        self.up_concat_2 = unetUp(self.filters[3], self.filters[-2], self.filters[3], self.ESCC)
        self.up_concat_1 = unetUp(self.filters[2], self.filters[-3], self.filters[2], self.ESCC)
        self.up_concat_0 = unetUp(self.filters[1],  self.filters[-4], self.filters[1], self.ESCC)
